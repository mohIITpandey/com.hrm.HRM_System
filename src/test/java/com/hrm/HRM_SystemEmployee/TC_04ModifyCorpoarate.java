...
public class TC_04ModifyCorpoarate {
		        ...
		        homePage.getCorporateModule().click();
		          ...
		          loginPage.getUserNameTxtBox().sendKeys(headUsername1);
		            ...
		            loginPage.getSignInBtn().click();
		             ...
		             homePage.getAddCorporateModule().click();
			         corporatePage.getSearchTxtBox().sendKeys(corporateName);
			         corporatePage.getEditCorporate(driver, corporateName).click();
			         corporatePage.getEditCorporateTxtBox(driver, corporateName).clear();
			         String newCorporateName = exUtils.getExcelData("CorporateModule",1,2);
			         corporatePage.getEditCorporateTxtBox(driver, corporateName).sendKeys(newCorporateName);
			         corporatePage.getUpdateCorporateBtn(driver, corporateName).click();
		             weutils.switchToAlertPopupAndAccept(driver, "Successfully");
